...
export default function EditAd({ navigation, route }) {
    ...
    const [subcategory, setsubcategory] = React.useState(ExistingItem.sub_category);
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headview}>
                <Text style={styles.heading}><FontAwesome5 onPress={() => navigation.goBack()} name='arrow-left' size={18} color={'white'} style={styles.topicon} solid />  Edit Ad</Text>
